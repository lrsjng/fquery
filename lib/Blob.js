...
Blob.error = function (method, message, blob, err, line, column) {

	Event.error(method, message, undefined, blob, line, column, err);
};
...
_.extend(Blob.prototype, {
	...
	error: function (method, message, err, line, column) {

		Event.error(method, message, undefined, this, line, column, err);
		return this;
	},
	...
	write: function (filepath) {
		...
		try {
			...
			Event.ok('write', filepath, undefined, this);
		} catch (e) {
