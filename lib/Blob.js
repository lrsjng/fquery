...
var Blob = module.exports = function (source, content, timestamp) {
...
// Constructors
// ------------
Blob.create = function (filepath, content, timestamp) {
...
_.extend(Blob.prototype, {
	...
	clone: function () {
		...
		return new Blob(this.source, this.content, this.timestamp ? moment(this.timestamp) : this.timestamp);
	},
